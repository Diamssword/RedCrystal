...
public class RedCrystalPlugin extends JavaPlugin {
	...
	private static void initBehaviors(RedComponentRegister register) {
		...
		register.register("Projectile", ProjectileBehavior::new, BehaviorAssetWithInteraction::Codec);
		...
		register.register("RangeEncoder", RangeEncoder::new, RangeEncoder.CODEC);
		register.register("RangeDecoder", RangeDecoder::new, RangeDecoder.CODEC);
